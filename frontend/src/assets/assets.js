...
/**
 * @typedef {Object} LogoRequest
 * @property {string} title
 * @property {string} colorSchemeId
...
/**
 * @typedef {Object} ILogo
 * @property {string} _id
 * @property {string} userId
 * @property {string} title
 * @property {string} [description]
 * @property {"Bold & Graphic" | "Tech/Futuristic" | "Minimalist" | "Photorealistic" | "Illustrated"} style
 * @property {"16:9" | "1:1" | "9:16"} [aspect_ratio]
 * @property {"vibrant" | "sunset" | "forest" | "neon" | "purple" | "monochrome" | "ocean" | "pastel"} [color_scheme]
 * @property {boolean} [text_overlay]
...
// Export a dummy object for ILogo type compatibility
export const ILogo = {};
...
// Export a dummy object for IUser type compatibility
export const IUser = {};
            ...
            <div class="flex pt-14">
                ...
                <main class="lg:ml-60 w-full px-6 py-6">
                    ...
                    <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <article>
                            <img src="%%LOGO_URL%%" class="rounded-xl aspect-video object-top" />
                            <div class="flex gap-3 mt-3">
